      ...
      <>
          ...
          <div className='d-flex flex-column align-items-center w-100 mt-3'>
            <form>
              ...
              <div className='d-flex flex-row flex-nowrap justify-content-center mt-3 w-60'>
                <button type='button' className='btn btn-info' onClick={handleSend}>Iniciar Sesion</button>
              </div>
            </form>
          </div>
